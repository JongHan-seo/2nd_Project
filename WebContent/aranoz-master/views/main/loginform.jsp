            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        <figure><img src="/images/signin-image.gif" alt="sing up image"></figure>
                        
                        <a href="join.jsp" class="signup-image-link">Create an account</a>
                    </div>

                    <div class="signin-form">
                        <h2 class="form-title">Log In</h2>
                        <form action="<%=ctx%>/login.do" method="POST" class="register-form" id="login-form">
